...
void UDPSocket::setBroadcast() {
 ...
 if (setsockopt(sockDesc, SOL_SOCKET, SO_REUSEADDR,
             (raw_type *) &broadcastPermission, sizeof(broadcastPermission))<0)
...
void UDPSocket::joinGroup(const string &multicastGroup,const string &source_iface) throw(SocketException)
{
  ...
  u_int yes = 1;
  if(setsockopt(sockDesc,SOL_SOCKET,SO_REUSEADDR,&yes,sizeof(yes))<0)
      throw SocketException("Reusing Add Failed", true);
